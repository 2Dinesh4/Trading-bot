    ...
    def __init__(self):
        ...
        try:
            ...
            if not api_key or not api_secret:
                ...
                # ✅ FIX: Sync timestamp with Binance server
                try:
            ...
            if isinstance(e, BinanceAPIException):
                if e.code == -2015:
                    ...
                    print("❌ Binance Timestamp Error: Your system clock is out of sync.")
                    print("   Please sync your Windows clock: Settings → Time & Language → Sync now")
                else:
                    print(f"❌ Binance API Error (code {e.code}): {str(e)}")
            else:
